...
**LICENCIA: CC BY 4.0 → TEXTO COMPLETO.** *"This is an Open Access article distributed under the terms of the Creative Commons Attribution License"* (https://creativecommons.org/licenses/by/4.0/). Verificado el 2026-09-21 en la página del artículo y en el depósito de la editorial en Crossref. Atribución: Little MA, Varoquaux G et al., *GigaScience* 6(5) (2017), DOI 10.1093/gigascience/gix020. **Cambios** respecto del original, como pide la licencia: texto extraído de la versión HTML de PMC; se omite el armazón del sitio (lista de afiliaciones desplegables, botones, enlaces "Find articles by…"); las fórmulas en imagen no se extraen y aparecen como "(1)", "(2)"…; se añaden esta cabecera y las secciones marcadas como nuestras.
