...
**LICENCIA: CC BY 4.0 → TEXTO COMPLETO.** *"© 2023 The Author(s) This is an open access article under the CC BY license"* (https://creativecommons.org/licenses/by/4.0/). Verificado el 2026-09-21 en la página del artículo y en el depósito de la editorial en Crossref. Atribución: Kapoor S, Narayanan A, *Patterns* 4(9):100804 (2023), DOI 10.1016/j.patter.2023.100804. **Cambios** respecto del original, como pide la licencia: texto extraído de la versión HTML de PMC; se omite el armazón del sitio (lista de afiliaciones desplegables, botones, enlaces "Find articles by…"); las fórmulas en imagen no se extraen y aparecen como "(1)", "(2)"…; se añaden esta cabecera y las secciones marcadas como nuestras.
