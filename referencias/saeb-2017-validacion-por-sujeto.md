...
**LICENCIA: CC BY 4.0 → TEXTO COMPLETO.** *"This is an Open Access article distributed under the terms of the Creative Commons Attribution License"* (https://creativecommons.org/licenses/by/4.0/). Verificado el 2026-09-21 en la página del artículo y en el depósito de la editorial en Crossref. Atribución: Saeb S et al., *GigaScience* 6(5) (2017), DOI 10.1093/gigascience/gix019. **Cambios** respecto del original, como pide la licencia: el texto se extrajo de la versión HTML de PMC con un script que conserva el contenido del elemento `<article>` y quita etiquetas, scripts y botones. **No se omite el resto del armazón del sitio**, que queda mezclado con el artículo: nombres de autor duplicados, afiliaciones repetidas, enlaces "Find articles by…", "Open in a new tab" junto a cada figura, las etiquetas "[DOI]", "[PubMed]", "[PMC free article]" y "[Google Scholar]" tras las referencias, "PMC Copyright notice", "Click here for additional data file" junto a cada material suplementario y la línea final "Articles from … are provided here courtesy of …". La línea de cita inicial perdió el nombre de la revista. Las figuras 1 a 5 son imágenes y no se reproducen; quedan su número y su leyenda. La fórmula en imagen no se extrae y queda como "(1)". Se añaden esta cabecera y las secciones marcadas como nuestras. *Hasta el 2026-09-21 esta nota decía que se omitían las afiliaciones desplegables, los botones y los enlaces "Find articles by…"; de eso solo era cierto lo de los botones.*
