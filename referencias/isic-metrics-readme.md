<!--
Fuente: https://raw.githubusercontent.com/ISIC-Research/Challenge-2024-Metrics/main/README.md
Copia literal tomada el 2026-08-12 por el agente (raw.githubusercontent.com sí es legible sin sesión).

Motivo: el informe cita el 88% TPR del esquema de premios del organizador para
contrastarlo con el 80% de Kaggle. Ese valor NO aparece en el script
PrimaryMetric-pAUC.py —allí min_tpr es un parámetro sin valor por defecto—, así
que citarlo exigía guardar la fuente donde sí está escrito. Este README es esa
fuente.

Dos detalles citables desde aquí:
- El umbral 88% y el rango resultante [0.00, 0.12].
- La redacción "required to be highly-specific", que contradice a Kaggle
  ("highly-sensitive") sobre la misma restricción. Como el umbral acota el TPR,
  la de Kaggle es la correcta.
-->
