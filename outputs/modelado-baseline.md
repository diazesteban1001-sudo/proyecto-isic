...
Columnas excluidas: 15 · features usadas: 39
...
Nivel 1 (logística balanceada): pAUC media 0.1326 ± 0.009 (62.6% del recorrido azar→perfecto)
Nivel 2a (GB sin balancear): pAUC media 0.0005 ± 0.0003 (-10.8% del recorrido azar→perfecto)
Nivel 2b (GB balanceado): pAUC media 0.1398 ± 0.018 (66.6% del recorrido azar→perfecto)
